<template>
  <el-card shadow="never">
    ...
    <el-row class="mb-2">
      <el-button v-auth="'mp:user:save'" type="primary" icon="Plus" @click="handleAddOrEdit()">新增</el-button>
      <el-button v-auth="'mp:user:delete'" type="danger" icon="Delete" @click="handleDeleteBatch()">删除</el-button>
    </el-row>
    <el-table
    ...
    >
      ...
      <el-table-column label="关注场景" prop="subscribeScene" header-align="center" align="center" />
      ...
      <el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
        <template #default="scope">
          <el-button v-auth="'mp:user:update'" type="primary" link @click="handleAddOrEdit(scope.row.id)">编辑</el-button>
          <el-button v-auth="'mp:user:delete'" type="danger" link @click="handleDeleteBatch(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
import { page, deleteByIds } from '@/api/mp/user'

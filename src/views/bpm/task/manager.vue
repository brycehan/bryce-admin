<template>
  <el-card shadow="never">
    ...
    >
      ...
      <el-table-column align="center" label="任务结束时间" prop="endTime" width="180" />
...
const state: StateOptions = reactive({
  api: {
    postPageApi: taskApi.postTaskManagerPage,
  },
  queryForm: {
    id: '',
    startUserId: null,
...
const handleDetail = (row: any) => {
  router.push({ name: 'BpmTaskManagerDetail', params: { id: row.processInstanceId } })
}

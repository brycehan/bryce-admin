    ...
    >
      ...
      <el-table-column label="操作" fixed="right" header-align="center" align="center" min-width="90">
        <template #default="scope">
          <el-button v-auth="'bpm:task:todo-page'" type="primary" icon="Edit" link @click="handleDetail(scope.row)">办理</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
const state: StateOptions = reactive({
  api: {
    postPageApi: taskApi.postTaskTodoPage,
  },
  queryForm: {
    id: '',
    startUserId: null,
...
const handleDetail = (row: any) => {
  router.push({ name: 'BpmTaskTodoDetail', params: { id: row.processInstanceId } })
}

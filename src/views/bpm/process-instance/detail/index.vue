<template>
  <el-card shadow="never" class="position-relative">
...
import { BpmFormType, BpmModelType } from '@/api/bpm/constant'
...
// import { FieldPermissionType } from '@/components/simple-process-designer-v2/src/consts'
...
import { FieldPermissionType } from '@/api/bpm/consts.ts'

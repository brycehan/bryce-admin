<template>
  <el-card shadow="never">
    ...
    <el-row class="mb-2">
      <el-button v-auth="'system:notice:save'" type="primary" icon="Plus" @click="handleAddOrEdit()">新增</el-button>
      <el-button v-auth="'system:notice:delete'" type="danger" icon="Delete" @click="handleDeleteBatch()">删除</el-button>
    </el-row>
    <el-table
    ...
    >
      ...
      <el-table-column label="标题" prop="title" show-overflow-tooltip header-align="center" align="center" />
      ...
      <el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
        <template #default="scope">
          <el-button v-auth="'system:notice:update'" type="primary" link @click="handleAddOrEdit(scope.row)">编辑</el-button>
          <el-button v-auth="'system:notice:delete'" type="danger" link @click="handleDeleteBatch(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
    ...
    <el-drawer v-if="addOrEditVisible" v-model="addOrEditVisible" :title="addOrEditTitle" :size="1000">
      <AddOrEdit v-model="addOrEditVisible" :addOrEditVisible="addOrEditVisible" :notice-id="noticeId" @refresh-page="getPage" />
    </el-drawer>
  </el-card>
</template>
...
import { page, deleteByIds } from '@/api/system/notice'

<template>
  <div class="panel-tab__content">
    ...
    <!--      <el-button type="primary" icon="plus" @click="openFieldForm(null, -1)">添加字段</el-button>-->
    <!--    </div>-->
...
// 打开字段 某个 配置项 弹窗
const openFieldOptionForm = (option: any, index: any, type: any) => {
...
// 移除某个 字段的 配置项
const removeFieldOptionItem = (option: any, index: any, type: any) => {

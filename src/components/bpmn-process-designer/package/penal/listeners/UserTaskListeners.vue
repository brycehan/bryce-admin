  ...
  <div class="panel-tab__content">
    <el-table :data="elementListenersList" size="small" border>
      ...
      <el-table-column
        ...
        :formatter="(row: any) => listenerEventTypeObject[row.event]"
      />
...
const listenerEventTypeObject = ref<any>(eventType)
...
// 移除监听器
const removeListener = (listener: any, index?: any) => {
...
// 移除监听器字段
const removeListenerField = (field: any, index: any) => {

<template>
  <div class="panel-tab__content">
    ...
    <div class="element-drawer__button">
      <el-button type="primary" icon="plus" size="small" @click="openListenerForm(null)">添加监听器</el-button>
    ...
    <el-dialog v-model="listenerFieldFormModelVisible" title="字段配置" width="600px" append-to-body destroy-on-close>
      <el-form ref="listenerFieldFormRef" :model="listenerFieldForm" label-width="96spx" style="height: 136px">
...
const listenerTypeObject = ref<any>(listenerType)
const fieldTypeObject = ref<any>(fieldType)
...
// 移除监听器字段
const removeListenerField = (index: any) => {
...
// 移除监听器
const removeListener = (index: any) => {
